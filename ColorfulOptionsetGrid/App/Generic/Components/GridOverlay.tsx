...
export const GridOverlay = ({isSubgrid, updatedProperties, setFullScreen, selection, dataset, selectedCount, children, containerHeight}: IGridOPverlayProps): JSX.Element  => {
    ...
    if(isSubgrid===true && isFullScreen===false ){
        return (                 
            <>
                {toggleFullScreen && <div className="ColorfulOptionsetGrid actionBar">
    ...
    return (      
        <Stack grow verticalFill className="ColorfulOptionsetGrid container" style={{height, width: "100%"}}>             
            <Stack.Item grow className="ColorfulOptionsetGrid gridContainer" >
